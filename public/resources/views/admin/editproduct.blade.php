            ...
            <form class="form-horizontal" method="post" action="{{ route('saveproduct') }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="sub_child_category_id" id="sub_child_category_id" class="form-control">
                                    <option value="{{ $childsub->id }}">{{ $childsub->subchildcategory }}</option>
                                </select>
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <label for="price" class="text-right control-label col-form-label">Product
                                    Description</label>
                                <textarea name="description" id="description" col="12" rows="10" class="form-control">{{$product->description}}</textarea>
                                <script>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="tags-input" class="text-right control-label col-form-label">Product
                                    Keywords</label>
                                @php
                                $tagsArray = unserialize($product->tags);
                                @endphp

                                <input type="text" class="form-control" id="tags-input" value="{{ implode(',', $tagsArray) }}" placeholder="Enter tags" name="tags[]">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-row" id="attribute_fields">
                            @foreach(unserialize($product->attribute) as $key => $attribute)
                            @if(unserialize($product->details)[$key] !=null && $attribute !=null)
                            <div class="form-group col-md-4">
                                <label for="attribute">Attribute<span class="text-danger">*</span></label>
                                <input type="text" placeholder="Attribute" id="attribute" class="form-control" name="attribute[]" value="{{ $attribute }}">
                                <div class="error text-danger" id="attributes-error"></div>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="details">Details<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="details" placeholder="Details" name="details[]" value="{{ unserialize($product->details)[$key] }}">
                ...
                <div class="card">
                    <h4 class="card-title">Which Picture Want You Delete</h4>
                    <div class="card-body">
                        ...
                        <div class="image-container" style="display: inline-block; margin-right: 10px; ">
                            <input type="checkbox" id="deleteCheckbox_{{ $image->id }}" name="deletelist[]" value="{{ $image->id }}">
                            <label for="deleteCheckbox_{{ $image->id }}">
                                <img src="{{ $thumbPath }}" alt="Image {{ $image->id }}" style="max-width: 100px; max-height: 100px;">
                            </label>
                        </div>
                        @endforeach
                ...
                <div class="form-row">
                    <div class="col-md-12">
                        <label for="video" class="text-right control-label col-form-label">Video</label>
                        <input type="url" name="video" id="video" @if(isset($vedio)) value="{{$vedio->video}}" @endif class="form-control">
                    </div>
                </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="vendorname" value="{{$product->vendorname}}" required id="vendorname">
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="col-md-12">
                    <label class="radio-inline" style="margin-right: 50px;">
                        <input type="radio" name="price_setting" value="variable" @if($product->price_setting== 'variable') checked @endif onclick="toggleFields('variable')"> Set variable price according to MOQ
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="price_setting" value="uniform" @if($product->price_setting== 'uniform') checked @endif onclick="toggleFields('uniform')"> Set uniform price
                    </label>
            ...
            <div class="form-row">
                <div class="col-md-5">
                    ...
                    @foreach ($unitList as $value => $name) 
                        <option value="{{$value}}" @if($product->unit == $value) selected @endif>{{$name}}</option>
                        @endforeach
                        </optgroup>
                        @endforeach
                    </select>
            ...
            <div class="form-row" id="variable"  @if($product->price_setting == "uniform") style="display: none" @endif >
                @if($product->variablemoq !=null)
            @foreach(unserialize($product->variablemoq) as $key => $variablemoq)
                <div class="form-group col-md-3 float-left">
                    <label for="variablemoq">MOQ (unit)<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="variablemoq" placeholder="MOQ (unit)" value="{{$variablemoq}}" name="variablemoq[]" value="">
                </div>
                <div class="form-group col-md-3 float-left">
                    <label for="variableprice">Price (US $)<span class="text-danger">*</span></label>
                    <input type="number" class="form-control" id="variableprice" placeholder="Price (US $)" value="{{ unserialize($product->variableprice)[$key] }}" name="variableprice[]">
                </div>
                @endforeach
                @endif
            ...
            <div id="uniform" @if($product->price_setting == "variable") style="display: none" @else style="display: block" @endif>
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label for="uniform_moq" class="text-right control-label col-form-label">MOQ</label>
                        <div class="input-group">
                            <input type="text" class="form-control" name="uniform_moq" value="{{$product->uniform_moq}}" id="uniform_moq">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <select data-placeholder="FOB Price" class="form-control" id="FOBprice" name="FOBprice">
                            ...
                            <option value="{{ $currencyGroup->currency }}" @if($product->FOBprice == $currencyGroup->currency) selected @endif>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="uniform_moq_min_price" value="{{$product->uniform_moq_min_price}}"  placeholder="Min MOQ Price" name="uniform_moq_min_price">
                            <div class="input-group-prepend">
                                <span class="input-group-text">-</span>
                            </div>
                            <input type="text" class="form-control" id="uniform_moq_max_price" value="{{$product->uniform_moq_max_price}}"   placeholder="Max MOQ Price" name="uniform_moq_max_price">
                        </div>
