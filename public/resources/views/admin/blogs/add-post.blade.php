                ...
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="post_content" name="post_content" placeholder="Content..." rows="6" required></textarea>

                            <span class="text-danger error-text post_content_error"></span>
                        </div>
                        <div class="form-group mb-3">
                                <label for="tags-input" >Keywords</label>
                                <input type="text" class="form-control" id="tags-input" placeholder="Enter Keywords for SEO" name="tags[]" required>
                                <div class="error text-danger" id="tags-input-error"></div>
                        </div>
                        <div class="form-group mb-3">
                                <label for="tags-input" >Description</label>
                                <input type="text" class="form-control" id="description" placeholder="Enter Description for SEO " name="description" required>
                                <div class="error text-danger" id="tags-input-error"></div>
                        </div>
                    </div>
                    <div class="col-md-3">
