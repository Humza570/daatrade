...
<![endif]-->
<style>.circle-image {
    width: 50px; /* Set the desired width and height of the circle */
    height: 50px;
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic"
                                ...
                                aria-expanded="false"><img src="{{ asset('assets/admin/images/users/1.jpg') }}"
                    ...
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('products') }}" aria-expanded="false"><i
                                    class="mdi mdi-chart-bar"></i><span class="hide-menu">Products</span></a></li>
                        @if (Auth::check() && Auth::user()->role == 'admin')
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                    href="{{ route('membershipmanagement') }}" aria-expanded="false"><i
                                        class="mdi mdi-chart-bubble"></i><span class="hide-menu">Membership
                                        Management</span></a></li>
                            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                    href="{{ route('vendormanagement') }}" aria-expanded="false"><i
                                        class="mdi mdi-chart-bubble"></i><span class="hide-menu">Vendor
                                        Management</span></a></li>
                                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                    href="{{ route('buyermanagement') }}" aria-expanded="false"><i
                                        class="mdi mdi-chart-bubble"></i><span class="hide-menu">Buyer
                                        Management</span></a></li>
                                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                    href="{{ route('subscribermanagement') }}" aria-expanded="false"><i
                                        class="mdi mdi-chart-bubble"></i><span class="hide-menu">Subscriber
                                        Management</span></a></li>
                                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                                    href="javascript:void(0)" aria-expanded="false"><i
                                        class="mdi mdi-receipt"></i><span class="hide-menu">Page Management </span></a>
                                <ul aria-expanded="false" class="collapse  first-level">
                                    <li class="sidebar-item"><a href="{{ route('editpage','about') }}"
                                            class="sidebar-link"><i class="mdi mdi-note-outline"></i><span
                                                class="hide-menu"> About
                                            </span></a></li>
                                            <li class="sidebar-item"><a href="{{ route('editpage','benefitsupplier') }}"
                                            class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
                                                class="hide-menu"> Supplier Benefits
                                            </span></a></li>
                                            <li class="sidebar-item"><a href="{{ route('editpage','benefitbuyer') }}"
                                            class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
                                                class="hide-menu"> Buyer Benefits
                                            </span></a></li>
                                            <li class="sidebar-item"><a href="{{ route('editpage','registerbuyer') }}"
                                            class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
                                                class="hide-menu">How to Register as Buyer
                                            </span></a></li>
                                            <li class="sidebar-item"><a href="{{ route('editpage','registersupplier') }}"
                                            class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
                                                class="hide-menu">How to Register as Supplier
                                            </span></a></li>
                                            <li class="sidebar-item"><a href="{{ route('editpage','inquirybuyer') }}"
                                            class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
                                                class="hide-menu">How to Post your Buying Inquiry
                                            </span></a></li>
                                    <li class="sidebar-item"><a href="{{ route('editpage','privacy') }}"
                                            class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
                                                class="hide-menu"> Privacy Ploicy
                                            </span></a></li>
                                            <li class="sidebar-item"><a href="{{ route('editpage','faq') }}"
                                            class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
                                                class="hide-menu"> FAQ
                                            </span></a></li>
                                </ul>
                            ...
                            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                    href="{{ route('newsletter') }}" aria-expanded="false"><i
                                        class="mdi mdi-receipt"></i><span class="hide-menu">News
                                        Letter</span></a></li>
                            ...
                            <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                                ...
                                <ul aria-expanded="false" class="collapse  first-level">
                                    <li class="sidebar-item"><a href="{{ route('categories') }}"
                                            class="sidebar-link"><i class="mdi mdi-note-outline"></i><span
                                                class="hide-menu"> Category
                                            </span></a></li>
                                    <li class="sidebar-item"><a href="{{ route('subcategories') }}"
                                            class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
                                                class="hide-menu"> Sub Categories
                                            </span></a></li>
                                    <li class="sidebar-item"><a href="{{ route('subchildcategories') }}"
                                            class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
                                                class="hide-menu"> Sub Child Categories
                                            </span></a></li>
                                </ul>
                            </li>
                            <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                                    href="javascript:void(0)" aria-expanded="false"><i
                                        class="mdi mdi-receipt"></i><span class="hide-menu">Blogs </span></a>
                                <ul aria-expanded="false" class="collapse  first-level">
                                    <li class="sidebar-item"><a href="{{ route('blogs.settings') }}"
                                            class="sidebar-link"><i class="mdi mdi-note-outline"></i><span
                                                class="hide-menu"> Settings
                                            </span></a></li>
                                    <li class="sidebar-item"><a href="{{ route('blogs.author') }}"
                                            class="sidebar-link"><i class="mdi mdi-note-outline"></i><span
                                                class="hide-menu"> Authors
                                            </span></a></li>
                                    <li class="sidebar-item"><a href="{{ route('blogs.categories') }}"
                                            class="sidebar-link"><i class="mdi mdi-note-outline"></i><span
                                    ...
                                    <li class="sidebar-item"> <a
                                            ...
                                            href="javascript:void(0)" aria-expanded="false"><i
                                                class="mdi mdi-receipt"></i><span class="hide-menu">Posts </span></a>
                                        <ul aria-expanded="false" class="collapse  first-level">
                                            <li class="sidebar-item"><a href="{{ route('posts.all.post') }}" class="sidebar-link"><i
                                                        class="mdi mdi-note-outline"></i><span class="hide-menu"> All
                                                        Posts
                                                    </span></a></li>
                                            <li class="sidebar-item"><a href="{{ route('posts.add.post') }}"
                                                    class="sidebar-link">
                        ...
                        @if (Auth::check() && (Auth::user()->role == 'admin' || Auth::user()->role == 'supplier'))
                            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                    href="{{ route('inquiries') }}" aria-expanded="false"><i
                                        class="mdi mdi-chart-bar"></i><span class="hide-menu">Inquiries</span></a>
                            </li>
                        @endif
                    </ul>
                </nav>
