        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="product__details__pic">
                    <div class="product__details__pic__item">
                        ...
                        @endphp
                        <img class="product__details__pic__item--large" src="{{ $imagePath }}" alt="Daatrade">
                    </div>
                    <div class="product__details__pic__slider owl-carousel">
                        ...
                        @endphp
                        <img data-imgbigurl="{{ $thumbPath }}" src="{{ $thumbPath }}" alt="Daatrade">
                        @endforeach
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <p>Daa Mines Private Limited is the exporter of Metallic minerals products. Paksitan is enriched with huge reserves of Metallic Minerals in KPK , Chagi, Balochistan and other Northern Areas of Pakistan. Daa Mines Private Limited is one of the poineer company has facilitated mining, producton and refining of these high demand mineral products. Our Metallic mineral products range includes Golden Granite Chrome Ore Concentrate or Chromite Ore Concentrate, Iron Ore, Mananese Ore, Soap Stones, Slica Quartz Stone, Granite stone, Marble and Sodium Chloride Industrial Grade. Some of mertallic minerals such as Granite, Golden granite Chrome Ore concentrate and Iron ore lumps or concentrate are the worlds’ most consumed insutrial metal mineral in the world. We have shipped metallic minerals to China, South Korea and Japan markets, now we are focusing to penetrate in new South East Asian and European markets with our competitive prices and high quality natural metallic menerals products.
                    </p>
                </div>
                <div>
                    <div class="product__details__text">
