...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">Add NewsLetter</h4>
...
<div class="container">
    <form method="post" action="{{ route('send-newsletter') }}" enctype="multipart/form-data" id="addPostForm">
        @csrf
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="message" name="message" placeholder="Body..." rows="6" required></textarea>
